...
func (a *ArticleSanitizer) Info() *entity.PluginInfo {
...
func (a *ArticleSanitizer) Load(ctx *entity.Plugin) error {
	a.ctx = ctx
...
func (a *ArticleSanitizer) ArticleCreateBefore(item *model.Article) error {
	if a.EnableOnCreate {
...
func (a *ArticleSanitizer) ArticleUpdateBefore(item *model.Article) error {
	if a.EnableOnUpdate {
...
func (a *ArticleSanitizer) sanitize(item *model.Article, action string) error {
...
func (a *ArticleSanitizer) removeLinks(item *model.Article) error {
...
func (a *ArticleSanitizer) Run(ctx *entity.Plugin) (err error) {
	return nil
}
