...
func (a *GenerateSlug) Info() *entity.PluginInfo {
...
func (a *GenerateSlug) Load(ctx *entity.Plugin) error {
...
func (a *GenerateSlug) Run(ctx *entity.Plugin) error {
	return nil
}
...
func (e *GenerateSlugEvent) ArticleCreateBefore(item *model.Article) (err error) {
	if item.Slug == "" {
...
func (e *GenerateSlugEvent) CategoryCreateBefore(item *model.Category) (err error) {
	if item.Slug == "" {
		item.Slug, err = e.makeSlug()
	}
	return
...
func (e *GenerateSlugEvent) TagCreateBefore(item *model.Tag) (err error) {
	if item.Slug == "" {
		item.Slug, err = e.makeSlug()
	}
	return
