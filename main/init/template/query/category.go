...
// Get by id
func (c *Category) Get(id int) *model.Category {
...
// List 调用列表
func (c *Category) List() (res []model.Category) {
...
// ListByID 根据ID调用文章列表
func (c *Category) ListByID(ids ...int) (res []model.Category) {
...
func (c *Category) PseudorandomList() (res []model.Category) {
...
func (c *Category) GetWithParent(id int) (res []model.Category) {
...
// Children 子分类列表
func (c *Category) Children(parentID int) (res []model.Category) {
...
func (c *Category) ListWithChildren(ids ...int) (res []dto.CategoryTree) {
	var err error
	if len(ids) == 0 {
